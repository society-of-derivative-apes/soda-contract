...
contract Cans is ERC1155, Ownable {
    ...
    constructor(address sodaContract) public ERC1155("ipfs://example.com/{id}.json") {
    ...
    function claim(uint[] calldata tokenIds, uint[] calldata amounts) external {
